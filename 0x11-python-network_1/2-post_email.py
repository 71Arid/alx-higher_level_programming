...
The email parameter is provided as a command-line argument when running the script.
...
Note:
    This script uses the 'urllib.request' module to send the POST request, and it assumes
    that the server at the specified URL will correctly handle the request and respond
